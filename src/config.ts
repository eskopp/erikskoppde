...
import type { NavItem, SiteConfig, SocialLink } from './types/config';
...
export const SITE: SiteConfig = {
  ...
  description: 'Persönlicher Blog von Erik Skopp.',
  ...
  url: process.env.SITE_URL || 'https://erikskopp.de',
...
export const NAV: readonly NavItem[] = [
  ...
  { key: 'blog', href: '/blog', icon: 'lucide:notebook-pen' },
