...
MDX lets you drop Astro components — including client-side islands that wrap third-party JS libraries — straight into a post. Here's the [Lichess PGN Viewer](https://github.com/lichess-org/pgn-viewer) rendering the "Immortal Game" (Anderssen vs. Kieseritzky, 1851), navigable by click or arrow keys:
